 ...
 * @author amresh.singh
 */
public class GeospacialExample
{
 public static final String dbName = "helloworld";
 public static final String host = "c716.candidate.41.mongolayer.com";
 public static final int port = 10716;
...
{
 new GeospacialExample().runExample();
}
